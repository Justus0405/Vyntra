...
async function clearData(win: BrowserWindow) {
    const { response } = await dialog.showMessageBox(win, {
        message: "Are you sure you want to reset Vyntra?",
        detail: "This will log you out, clear caches and reset all your settings!\n\nVyntra will automatically restart after this operation.",
        buttons: ["Yes", "No"],
...
function initMenuBar(win: BrowserWindow) {
    ...
    const subMenu = [
        ...
        },
        {
            ...
            toolTip: "Vyntra will automatically restart after this operation"
        },
        {
            label: "Reset Vyntra",
            async click() {
