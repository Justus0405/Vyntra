...
const SettingsOptions: Record<string, Array<BooleanSetting | SettingsComponent>> = {
    ...
    "User Interface": [
        ...
        },
        {
            key: "staticTitle",
            title: "Static Title",
            description: 'Makes the window title "Vyntra" instead of changing to the current page',
            defaultValue: false
        },
        {
            key: "enableMenu",
    ...
    Behaviour: [
        {
            key: "tray",
            title: "Tray Icon",
            description: "Add a tray icon for Vyntra",
            defaultValue: true,
            invisible: () => isMac
        },
        {
            ...
            description: "Hitting X will make Vyntra minimize to the tray instead of closing",
            defaultValue: true,
            invisible: () => isMac,
        ...
        },
        {
            ...
            description: "Left clicking tray icon will toggle the Vyntra window visibility.",
            defaultValue: false
        },
        {
            key: "disableMinSize",
    ...
    Miscelleanous: [
...

        {
            ...
            description: "Opens links in a new Vyntra window instead of your web browser",
            defaultValue: false
        }
    ],
