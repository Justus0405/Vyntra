...
const latestReleaseInformation = await fetch("https://api.github.com/repos/Justus0405/Vyntra/releases/latest", {
    headers: {
...
const metaInfo = await fs.readFile("./meta/dev.vencord.Vyntra.metainfo.xml", "utf-8");
...
await fs.writeFile("./meta/dev.vencord.Vyntra.metainfo.xml", output, "utf-8");
